 ...
 */
declare const reduce: <TIn, TOut>(reducer: (accumulator: TOut, currentValue: TIn, presentIndex?: number) => TOut | Promise<TOut>, initialValue: TOut) => import("../../types").TTransIteratorSyncOrAsync<TIn, TOut>;
export { reduce };
