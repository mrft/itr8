 ...
 */
declare const runningReduce: <TIn, TOut>(reducer: (accumulator: TOut, currentValue: TIn, presentIndex?: number) => TOut | Promise<TOut>, initialValue: TOut) => import("../../types.js").TTransIteratorSyncOrAsync<TIn, TOut>;
