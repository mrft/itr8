...
const flatMap = function (mapFn) {
    const operatorFunction = (itIn) => {
        ...
        const generateFirstReturnValIfPossible = () => {
            return (0, index_js_1.pipe)(itIn.next(), (firstNextIn) => {
                inputIteratorIsAsync = (0, index_js_1.isPromise)(firstNextIn);
                return firstNextIn;
            }, (0, index_js_1.doAfter)((firstNextIn) => {
                if (firstNextIn.done) {
            ...
            }), (0, index_js_1.doAfter)((firstIterable) => {
                ...
                iterableIsAsync = (0, index_js_1.isPromise)(firstNext);
                return firstNext;
            }), (0, index_js_1.doAfter)((firstGeneratorNext) => {
        ...
        const returnedIterator = {
            ...
            next: () => {
                return (0, index_js_1.pipe)(generateFirstReturnValIfPossible(), (0, index_js_1.doAfter)((n) => (n !== null ? n : returnedIterator.next())));
            },
