    ...
    if (options.keepOrder === undefined || options.keepOrder) {
        return (inIt) => {
            async function* iteratorOfIterables() {
                ...
                const outIteratorOfIterators = (0, index_js_2.itr8Pushable)();
                ...
                (async () => {
                    ...
                    await (0, index_js_1.pipe)(inIt, (0, index_js_2.forEach)(async (inElement) => {
                        ...
                        const itOfItsElement = {
                            ...
                            subIt: (0, index_js_2.itr8Pushable)(),
                        };
                        ...
                        await (0, index_js_2.itr8ToArray)(itOfItsElement.callbackIt);
