...
const itr8FromString_js_1 = require("../../interface/itr8FromString.js");
 ...
 */
const stringToChar = () => (0, powerMap_js_1.powerMap)((nextIn, _state) => {
    if (nextIn.done) {
        return { done: true };
    }
    return {
        done: false,
        iterable: (0, itr8FromString_js_1.itr8FromString)(nextIn.value),
    };
}, () => undefined);
